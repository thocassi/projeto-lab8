...
export const unwrapReason: {
  ...
  <
    ...
    E
  >(errorTag: K): <A, R>(self: Stream<A, E, R>) => Stream<A, ExcludeTag<E, K> | ReasonOf<ExtractTag<E, K>>, R>
  /**
   * Promotes nested reason errors into the stream error channel, replacing the
   * parent error.
   *
  ...
  <
    ...
    R,
    K extends Effect.TagsWithReason<E>
  >(self: Stream<A, E, R>, errorTag: K): Stream<A, ExcludeTag<E, K> | ReasonOf<ExtractTag<E, K>>, R>
} = dual(
  2,
  <
    A,
