 ...
 * @since 4.0.0
 */
export declare const shutdownUnsafe: <A, E>(self: Enqueue<A, E>) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const flushUnsafe: <A, E>(self: Enqueue<A, E>) => void;
/**
 ...
 * @since 4.0.0
 */
export declare const flush: <A, E>(self: Enqueue<A, E>) => Effect<void>;
