 ...
 * @since 4.0.0
 */
export declare function Array<V extends Schema.ConstraintCodec<unknown, unknown>>(value: V, options?: ArrayOptions): Config<ReadonlyArray<V["Type"]>>;
export declare function Array<V extends Schema.ConstraintCodec<unknown, unknown>>(value: V, path: string | Path, options?: ArrayOptions): Config<ReadonlyArray<V["Type"]>>;
/**
 ...
 * @since 4.0.0
 */
export declare function Record<K extends Schema.Record.Key & Schema.ConstraintCodec<unknown, unknown>, V extends Schema.ConstraintCodec<unknown, unknown>>(key: K, value: V, options?: RecordOptions): Config<Schema.Record.Type<K, V>>;
export declare function Record<K extends Schema.Record.Key & Schema.ConstraintCodec<unknown, unknown>, V extends Schema.ConstraintCodec<unknown, unknown>>(key: K, value: V, path: string | Path, options?: RecordOptions): Config<Schema.Record.Type<K, V>>;
/**
 ...
 * @since 4.0.0
 */
export declare function ByteSize(name?: string): Config<import("./ByteSize.ts").ByteSize>;
/**
