 ...
 * @since 4.0.0
 */
export const takeBetween = /*#__PURE__*/dual(3, (self, min, max) => Effect.suspend(() => takeRemainderLoop(self, Count.normalize(min), Count.normalize(max), [])));
