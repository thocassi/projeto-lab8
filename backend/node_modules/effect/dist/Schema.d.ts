...
import { SchemaErrorTypeId } from "./internal/schemaError.ts";
 ...
 * @since 4.0.0
 */
export declare function extendTo<S extends Struct<Struct.Fields>, const Fields extends Struct.Fields>(fields: Fields, derive: {
 ...
 * @since 3.10.0
 */
export declare function Union<const Members extends ReadonlyArray<Constraint>>(members: Members, options?: SchemaAST.UnionOptions): Union<Members>;
/**
 ...
 * @since 4.0.0
 */
export declare function encodeTo<To extends Constraint>(to: To): <From extends Constraint>(from: From) => compose<From, To>;
 ...
 * @since 4.0.0
 */
export declare function isMultipleOf(divisor: number, annotations?: Annotations.Filter): SchemaAST.Filter<number>;
/**
 ...
 * @since 4.0.0
 */
export declare function isUniqueKey<Key, Value>(annotations?: Annotations.Filter): SchemaAST.Filter<readonly (readonly [Key, Value])[]>;
/**
...
export declare const StandardSchemaV1FailureResult: Struct<{
    readonly issues: $Array<Struct<{
        ...
        readonly path: optional<$Array<Union<readonly [
 ...
 * @since 4.0.0
 */
export declare const ByteSize: ByteSize;
/**
 ...
 * @since 4.0.0
 */
export declare const ByteSizeFromString: ByteSizeFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const ByteSizeFromBigInt: ByteSizeFromBigInt;
/**
 ...
 * @since 4.0.0
 */
export declare const ByteSizeFromNumber: ByteSizeFromNumber;
/**
 ...
 * @since 4.0.0
 */
export declare const MacAddressFromString: MacAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv4Address: Ipv4Address;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv4AddressFromString: Ipv4AddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv6Address: Ipv6Address;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv6AddressFromString: Ipv6AddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const IpAddress: IpAddress;
/**
 ...
 * @since 4.0.0
 */
export declare const IpAddressFromString: IpAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const IpMulticastAddress: IpMulticastAddress;
/**
 ...
 * @since 4.0.0
 */
export interface IpMulticastAddressFromString extends refine<NetAddress_.MulticastAddress<NetAddress_.IpAddress>, IpAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const IpMulticastAddressFromString: IpMulticastAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const MacMulticastAddress: MacMulticastAddress;
/**
 ...
 * @since 4.0.0
 */
export interface MacMulticastAddressFromString extends refine<NetAddress_.MulticastAddress<NetAddress_.MacAddress>, MacAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const MacMulticastAddressFromString: MacMulticastAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const IpUnicastAddress: IpUnicastAddress;
/**
 ...
 * @since 4.0.0
 */
export interface IpUnicastAddressFromString extends refine<NetAddress_.UnicastAddress<NetAddress_.IpAddress>, IpAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const IpUnicastAddressFromString: IpUnicastAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const MacUnicastAddress: MacUnicastAddress;
/**
 ...
 * @since 4.0.0
 */
export interface MacUnicastAddressFromString extends refine<NetAddress_.UnicastAddress<NetAddress_.MacAddress>, MacAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const MacUnicastAddressFromString: MacUnicastAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export interface Ipv4BroadcastAddress extends refine<NetAddress_.BroadcastAddress<NetAddress_.Ipv4Address>, Ipv4Address> {
 ...
 * @since 4.0.0
 */
export declare const Ipv4BroadcastAddress: Ipv4BroadcastAddress;
/**
 ...
 * @since 4.0.0
 */
export interface Ipv4BroadcastAddressFromString extends refine<NetAddress_.BroadcastAddress<NetAddress_.Ipv4Address>, Ipv4AddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const Ipv4BroadcastAddressFromString: Ipv4BroadcastAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const MacBroadcastAddress: MacBroadcastAddress;
/**
 ...
 * @since 4.0.0
 */
export interface MacBroadcastAddressFromString extends refine<NetAddress_.BroadcastAddress<NetAddress_.MacAddress>, MacAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const MacBroadcastAddressFromString: MacBroadcastAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const IpLoopbackAddress: IpLoopbackAddress;
/**
 ...
 * @since 4.0.0
 */
export interface IpLoopbackAddressFromString extends refine<NetAddress_.LoopbackAddress<NetAddress_.IpAddress>, IpAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const IpLoopbackAddressFromString: IpLoopbackAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const IpLinkLocalAddress: IpLinkLocalAddress;
/**
 ...
 * @since 4.0.0
 */
export interface IpLinkLocalAddressFromString extends refine<NetAddress_.LinkLocalAddress<NetAddress_.IpAddress>, IpAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const IpLinkLocalAddressFromString: IpLinkLocalAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const IpUnspecifiedAddress: IpUnspecifiedAddress;
/**
 ...
 * @since 4.0.0
 */
export interface IpUnspecifiedAddressFromString extends refine<NetAddress_.UnspecifiedAddress<NetAddress_.IpAddress>, IpAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const IpUnspecifiedAddressFromString: IpUnspecifiedAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv4PrivateAddress: Ipv4PrivateAddress;
/**
 ...
 * @since 4.0.0
 */
export interface Ipv4PrivateAddressFromString extends refine<NetAddress_.PrivateAddress<NetAddress_.Ipv4Address>, Ipv4AddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const Ipv4PrivateAddressFromString: Ipv4PrivateAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export interface Ipv6UniqueLocalAddress extends refine<NetAddress_.UniqueLocalAddress<NetAddress_.Ipv6Address>, Ipv6Address> {
 ...
 * @since 4.0.0
 */
export declare const Ipv6UniqueLocalAddress: Ipv6UniqueLocalAddress;
/**
 ...
 * @since 4.0.0
 */
export interface Ipv6UniqueLocalAddressFromString extends refine<NetAddress_.UniqueLocalAddress<NetAddress_.Ipv6Address>, Ipv6AddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const Ipv6UniqueLocalAddressFromString: Ipv6UniqueLocalAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export interface MacLocallyAdministeredAddress extends refine<NetAddress_.LocallyAdministeredAddress<NetAddress_.MacAddress>, MacAddress> {
 ...
 * @since 4.0.0
 */
export declare const MacLocallyAdministeredAddress: MacLocallyAdministeredAddress;
/**
 ...
 * @since 4.0.0
 */
export interface MacLocallyAdministeredAddressFromString extends refine<NetAddress_.LocallyAdministeredAddress<NetAddress_.MacAddress>, MacAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const MacLocallyAdministeredAddressFromString: MacLocallyAdministeredAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export interface MacUniversallyAdministeredAddress extends refine<NetAddress_.UniversallyAdministeredAddress<NetAddress_.MacAddress>, MacAddress> {
 ...
 * @since 4.0.0
 */
export declare const MacUniversallyAdministeredAddress: MacUniversallyAdministeredAddress;
/**
 ...
 * @since 4.0.0
 */
export interface MacUniversallyAdministeredAddressFromString extends refine<NetAddress_.UniversallyAdministeredAddress<NetAddress_.MacAddress>, MacAddressFromString> {
 ...
 * @since 4.0.0
 */
export declare const MacUniversallyAdministeredAddressFromString: MacUniversallyAdministeredAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv4Interface: Ipv4Interface;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv4InterfaceFromString: Ipv4InterfaceFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv6Interface: Ipv6Interface;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv6InterfaceFromString: Ipv6InterfaceFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const IpInterface: IpInterface;
/**
 ...
 * @since 4.0.0
 */
export declare const IpInterfaceFromString: IpInterfaceFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv4Network: Ipv4Network;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv4NetworkFromString: Ipv4NetworkFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv6Network: Ipv6Network;
/**
 ...
 * @since 4.0.0
 */
export declare const Ipv6NetworkFromString: Ipv6NetworkFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const IpNetwork: IpNetwork;
/**
 ...
 * @since 4.0.0
 */
export declare const IpNetworkFromString: IpNetworkFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const InetAddressV4: InetAddressV4;
/**
 ...
 * @since 4.0.0
 */
export declare const InetAddressV6: InetAddressV6;
/**
 ...
 * @since 4.0.0
 */
export declare const InetAddress: InetAddress;
/**
 ...
 * @since 4.0.0
 */
export declare const InetAddressFromString: InetAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const UnixPathAddress: UnixPathAddress;
/**
 ...
 * @since 4.0.0
 */
export declare const UnixPathAddressFromString: UnixPathAddressFromString;
/**
 ...
 * @since 4.0.0
 */
export declare const SocketAddress: SocketAddress;
/**
 ...
 * @since 4.0.0
 */
export interface Cookies extends declare<Cookies_.Cookies, Record_.ReadonlyRecord<string, Cookies_.Cookie>> {
 ...
 * @since 4.0.0
 */
export declare const RecordFromCookies: RecordFromCookies;
/**
 ...
 * @since 4.0.0
 */
export interface Headers extends declare<Headers_.Headers, {
 ...
 * @since 4.0.0
 */
export interface UrlParams extends declare<UrlParams_.UrlParams, ReadonlyArray<readonly [string, string]>> {
 ...
 * @since 4.0.0
 */
export declare const JsonFromUrlParamsField: (field: string, options?: {
    readonly reviver?: Parameters<typeof JSON.parse>[1] | undefined;
} | undefined) => JsonFromUrlParamsField;
/**
 ...
 * @since 4.0.0
 */
export interface RecordFromUrlParams extends decodeTo<$Record<String, Union<readonly [String, NonEmptyArray<String>]>>, UrlParams, never, never> {
 ...
 * @since 4.0.0
 */
export declare const RecordFromUrlParams: RecordFromUrlParams;
/**
 ...
 * @since 4.0.0
 */
export declare const toCodecJson: {
    /**
     * Derives a canonical JSON codec from a schema. The encoded form is `Json`, and
     * decoding produces the schema's `Type`.
     *
 ...
 * @since 4.0.0
 */
export declare const toCodecIso: {
    /**
     * Derives an isomorphism codec from a schema. The encoded form is the schema's
     * `Iso` type — the intermediate representation used for round-tripping.
     *
 ...
 * @since 4.0.0
 */
export declare const toCodecStringTree: {
    /**
     * Converts a schema to the StringTree canonical codec, where every leaf value
     * becomes a string while preserving the original structure.
     *
 ...
 * @since 4.0.0
 */
export declare const toCodecArrayFromSingle: {
    /**
     * Allows array schemas to decode from either an array input or a single value
     * input.
     *
 ...
 * @since 4.0.0
 */
export declare function toEncoderXml<T, RE>(codec: ConstraintCodec<T, unknown, unknown, RE>, options?: XmlEncoderOptions): (t: T) => Effect.Effect<string, SchemaIssue.Issue, RE>;
/**
 ...
 * @since 4.0.0
 */
export declare function toIsoSource<S extends Constraint>(schema: S): Optic_.Iso<S["Type"], S["Type"]>;
/**
 ...
 * @since 4.0.0
 */
export declare function toIsoFocus<S extends Constraint>(schema: S): Optic_.Iso<S["Iso"], S["Iso"]>;
/**
