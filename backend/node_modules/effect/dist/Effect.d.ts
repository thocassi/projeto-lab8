...
export declare namespace All {
    ...
    }, Mode extends true ? never : Error<ObjectValues<T>>, Services<ObjectValues<T>>> : never;
    /**
 ...
 * @since 4.0.0
 */
export declare const withFiberSucceed: <A, R = never>(evaluate: (fiber: Fiber<unknown, unknown>) => A) => Effect<A, never, R>;
/**
...
export declare const withErrorReporting: <Arg extends Effect<any, any, any> | {
    ...
    readonly defectsOnly?: boolean | undefined;
} | undefined) => [Arg] extends [Effect<infer A, infer E, infer R>] ? Effect<A, E, R> : <A, E, R>(self: Effect<A, E, R>) => Effect<A, E, R>;
/**
...
export declare const orElseSucceed: {
     ...
     * @since 2.0.0
     */
    <E, A2>(f: (error: NoInfer<E>) => A2): <A, R>(self: Effect<A, E, R>) => Effect<A2 | A, never, R>;
    /**
     * Recovers from a typed failure by producing a fallback success value.
     *
     * **Details**
     ...
     * @since 2.0.0
     */
    <A, E, R, A2>(self: Effect<A, E, R>, f: (error: E) => A2): Effect<A | A2, never, R>;
};
/**
...
export declare const repeatOrElse: {
     ...
     * @since 2.0.0
     */
    <R2, A, B, E, E2, E3, R3>(schedule: Schedule<B, A, E2, R2>, orElse: (error: E | E2, option: Option<ScheduleMetadata<B, A>>) => Effect<B, E3, R3>): <R>(self: Effect<A, E, R>) => Effect<B, E3, R | R2 | R3>;
    /**
     * Repeats an effect according to a schedule and runs a fallback effect if
     * repetition fails before the schedule completes.
     *
     ...
     * @since 2.0.0
     */
    <A, E, R, R2, B, E2, E3, R3>(self: Effect<A, E, R>, schedule: Schedule<B, A, E2, R2>, orElse: (error: E | E2, option: Option<ScheduleMetadata<B, A>>) => Effect<B, E3, R3>): Effect<B, E3, R | R2 | R3>;
};
/**
 ...
 * @since 4.0.0
 */
export declare const withLogger: {
    /**
     * Adds a logger to the set of loggers which will output logs for this effect.
     *
     * **Example** (Adding a logger to an effect)
...
export declare const track: {
     ...
     * @since 4.0.0
     */
    <Input, State, E, A>(metric: Metric.Metric<Input, State>, f: (exit: Exit.Exit<A, E>) => Input): <E2 extends E, R>(self: Effect<A, E2, R>) => Effect<A, E2, R>;
    /**
     * Updates a metric after each effect execution, optionally mapping its `Exit` to
     * the metric's input.
     *
...
type EffectifyArgs<F extends (...args: Array<any>) => any> = Parameters<F> extends [...infer Args, any] ? Args : Parameters<F>;
/**
...
export declare const effectify: {
     ...
     * @since 4.0.0
     */
    <F extends (...args: Array<any>) => any, E>(fn: F, onError: (error: Effectify.EffectifyError<F>, args: EffectifyArgs<F>) => E): Effectify.Effectify<F, E>;
    /**
     * Converts an error-first callback API into a function that returns an
     * `Effect`.
     *
     ...
     * @since 4.0.0
     */
    <F extends (...args: Array<any>) => any, E, E2>(fn: F, onError: (error: Effectify.EffectifyError<F>, args: EffectifyArgs<F>) => E, onSyncError: (error: unknown, args: EffectifyArgs<F>) => E2): Effectify.Effectify<F, E | E2>;
};
/**
