 ...
 * @since 4.0.0
 */
export declare const Context: new (isOptional: boolean, isMutable: boolean, /** Used for constructor default values (e.g. `withConstructorDefault` API) */ constructorDefault?: Effect.Effect<unknown, SchemaIssue.Issue> | undefined, annotations?: Schema.Annotations.Key<unknown> | undefined) => Context;
/**
