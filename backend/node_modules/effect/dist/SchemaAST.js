...
/** @internal */
export function stepArray(s, item, exit, i) {
...
/** @internal */
export const parseArray = /*#__PURE__*/iterateEager()(parseArrayOptions);
...
/** @internal */
export function stepProperty(s, p, exit) {
  if (exit._tag === "Failure") {
...
/** @internal */
export const parseProperties = /*#__PURE__*/iterateEager()(parsePropertiesOptions);
...
/** @internal */
export const parameterFromPropertyKey = /*#__PURE__*/applyToSelfOrLastLinkEncodingIdempotent(ast => {
  switch (ast._tag) {
    default:
      return ast;
    case "Number":
