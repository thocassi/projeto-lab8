...
const decodeFromCursor = (ast, decode) => SchemaAST.decodeTo(SchemaAST.unknown, ast, new SchemaTransformation.Transformation(SchemaGetter.transformEffect(input => decode(input)), SchemaGetter.passthrough()));
...
const PortSchema = /*#__PURE__*/Schema.Int.check(/*#__PURE__*/Schema.isBetween({
  minimum: 1,
  maximum: 65535
}));
const LogLevelSchema = /*#__PURE__*/Schema.Literals(LogLevel_.values);
const isPath = u => Predicate.isString(u) || globalThis.Array.isArray(u);
// -----------------------------------------------------------------------------
// constructors
// -----------------------------------------------------------------------------
/**
...
export function Array(value, pathOrOptions, options) {
  ...
  const arrayString = Schema.String.pipe(Schema.decodeTo(Schema.toCodecStringTree(array), {
    ...
    encode: SchemaGetter.compose(SchemaGetter.passthrough({
      strict: false
...
export function Record(key, value, pathOrOptions, options) {
  const hasPath = isPath(pathOrOptions);
