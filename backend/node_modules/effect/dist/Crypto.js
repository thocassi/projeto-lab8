...
import * as Ulid from "./internal/ulid.js";
...
export const make = impl => {
  ...
  return Crypto.of({
    ...
    randomULID: Effect.clockWith(clock => Effect.succeed(Ulid.ulidString(clock.currentTimeMillisUnsafe(), randomBytesUnsafe(10))))
  });
};
