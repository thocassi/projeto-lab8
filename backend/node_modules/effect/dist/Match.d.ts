...
declare const TypeId = "~effect/Match/Matcher";
...
export declare const valueTags: {
     ...
     * @since 4.0.0
     */
    <const I, P extends ValueTagHandlers<I> & {
        readonly [Tag in Exclude<keyof P, Types.Tags<"_tag", I>>]: never;
    }>(fields: Contextual<P, ValueTagHandlers<I>>): (input: I) => Unify<ReturnType<P[keyof P]>>;
    /**
     * Creates a match function for a specific value with discriminated union handling.
     *
     * **Details**
    ...
    <const I, P extends ValueTagHandlers<I> & {
        readonly [Tag in Exclude<keyof P, Types.Tags<"_tag", I>>]: never;
    }>(input: I, fields: Contextual<P, ValueTagHandlers<I>>): Unify<ReturnType<P[keyof P]>>;
};
/**
 ...
 * @since 4.0.0
 */
export declare const discriminators: <D extends string>(field: D) => <R, Ret, P extends PartialTagHandlers<D, R, Ret> & {
    readonly [Tag in Exclude<keyof P, Types.Tags<D, R>>]: never;
}>(fields: Contextual<P, PartialTagHandlers<D, R, Ret>>) => <I, F, A, Pr>(self: Matcher<I, F, R, A, Pr, Ret>) => Matcher<I, Types.AddWithout<F, Extract<R, Record<D, keyof P>>>, Types.ApplyFilters<I, Types.AddWithout<F, Extract<R, Record<D, keyof P>>>>, A | ReturnType<P[keyof P] & {}>, Pr, Ret>;
/**
 ...
 * @since 4.0.0
 */
export declare const discriminatorsExhaustive: <D extends string>(field: D) => <R, Ret, P extends TagHandlers<D, R, Ret> & {
    readonly [Tag in Exclude<keyof P, Types.Tags<D, R>>]: never;
}>(fields: Contextual<P, TagHandlers<D, R, Ret>>) => <I, F, A, Pr>(self: Matcher<I, F, R, A, Pr, Ret>) => [Pr] extends [never] ? (u: I) => Unify<A | ReturnType<P[keyof P]>> : Unify<A | ReturnType<P[keyof P]>>;
/**
 ...
 * @since 4.0.0
 */
export declare const tags: <R, Ret, P extends PartialTagHandlers<"_tag", R, Ret> & {
    readonly [Tag in Exclude<keyof P, Types.Tags<"_tag", R>>]: never;
}>(fields: Contextual<P, PartialTagHandlers<"_tag", R, Ret>>) => <I, F, A, Pr>(self: Matcher<I, F, R, A, Pr, Ret>) => Matcher<I, Types.AddWithout<F, Extract<R, Record<"_tag", keyof P>>>, Types.ApplyFilters<I, Types.AddWithout<F, Extract<R, Record<"_tag", keyof P>>>>, A | ReturnType<P[keyof P] & {}>, Pr, Ret>;
/**
 ...
 * @since 4.0.0
 */
export declare const tagsExhaustive: <R, Ret, P extends TagHandlers<"_tag", R, Ret> & {
    readonly [Tag in Exclude<keyof P, Types.Tags<"_tag", R>>]: never;
}>(fields: Contextual<P, TagHandlers<"_tag", R, Ret>>) => <I, F, A, Pr>(self: Matcher<I, F, R, A, Pr, Ret>) => [Pr] extends [never] ? (u: I) => Unify<A | ReturnType<P[keyof P]>> : Unify<A | ReturnType<P[keyof P]>>;
/**
...
declare const SafeRefinementId = "~effect/Match/SafeRefinement";
/**
