...
/** @internal */
export function formatUriFragmentToken(token) {
  return encodeURI(escapeToken(token)).replace(/#/g, "%23");
}
/** @internal */
export function decodeUriFragment(fragment) {
 ...
 * @since 4.0.0
 */
export function parseUriFragment(fragment) {
 ...
 * @since 4.0.0
 */
export function formatUriFragment(path) {
  return path.reduce((fragment, token) => `${fragment}/${formatUriFragmentToken(token)}`, "#");
}
