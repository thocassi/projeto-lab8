 ...
 * @since 2.0.0
 */
export const dropRight = /*#__PURE__*/dual(2, (self, n) => take(self, self.length - Math.min(Count.normalize(n), self.length)));
/**
 ...
 * @since 2.0.0
 */
export const split = /*#__PURE__*/dual(2, (self, n) => chunksOf(self, Math.ceil(self.length / Count.normalizeNonEmpty(n))));
/**
 ...
 * @since 2.0.0
 */
export const takeRight = /*#__PURE__*/dual(2, (self, n) => drop(self, self.length - Math.min(Count.normalize(n), self.length)));
/**
