...
const runGetter = (self, input, options) => {
  switch (self._tag) {
    ...
    case "TransformEffect":
      return Option.isNone(input) ? Effect.succeedNone : Effect.mapEager(self.transform(input.value, options), Option.some);
 ...
 * @since 4.0.0
 */
export const run = /*#__PURE__*/dual(3, runGetter);
const makeGetter = fields => Object.assign(Object.create(Pipeable.Prototype), fields);
const composeOptionalEffect = (first, second) => transformOptionalEffect((input, options) => Effect.flatMapEager(runGetter(first, input, options), output => runGetter(second, output, options)));
/**
 ...
 * @since 4.0.0
 */
export const compose = /*#__PURE__*/dual(2, (self, other) => {
    ...
    case "Transform":
      {
        switch (other._tag) {
          case "Transform":
            return transform(input => other.transform(self.transform(input)));
          case "TransformOptional":
            return transformOptional(input => other.transform(Option.map(input, self.transform)));
          case "TransformEffect":
            return transformEffect((input, options) => other.transform(self.transform(input), options));
          case "TransformOptionalEffect":
    ...
    case "TransformEffect":
      {
        switch (other._tag) {
          case "Transform":
            return transformEffect((input, options) => Effect.mapEager(self.transform(input, options), other.transform));
          case "TransformOptional":
          case "TransformOptionalEffect":
            return composeOptionalEffect(self, other);
          case "TransformEffect":
            return transformEffect((input, options) => Effect.flatMapEager(self.transform(input, options), output => other.transform(output, options)));
        }
      }
    case "TransformOptionalEffect":
      return composeOptionalEffect(self, other);
 ...
 * @since 4.0.0
 */
export const map = /*#__PURE__*/dual(2, (self, f) => compose(self, transform(f)));
/**
...
const passthrough_ = /*#__PURE__*/makeGetter({
  _tag: "Passthrough"
});
...
export function required(annotations) {
  return transformOptionalEffect(input => Option.isNone(input) ? Effect.fail(new SchemaIssue.MissingKey(annotations)) : Effect.succeed(input));
}
/**
 ...
 * @since 4.0.0
 */
export function transformOptionalEffect(f) {
  return makeGetter({
...
export function parseJson(options) {
  return transformEffect((input, parseOptions) => Effect.try({
