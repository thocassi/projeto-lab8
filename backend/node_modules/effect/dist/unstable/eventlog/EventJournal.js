...
export class Entry extends /*#__PURE__*/Schema.Class("effect/eventlog/EventJournal/Entry")({
   ...
   * @since 4.0.0
   */
  static arraySchemaBinary = /*#__PURE__*/Schema.Array(/*#__PURE__*/SchemaBinary.toCodec(Entry));
  /**
   * Encodes arrays of committed entries with the SchemaBinary entry codec.
   *
   * @since 4.0.0
   */
  static encodeArray = /*#__PURE__*/Schema.encodeUnknownEffect(Entry.arraySchemaBinary);
  /**
   * Decodes arrays of committed entries with the SchemaBinary entry codec.
   *
   * @since 4.0.0
   */
  static decodeArray = /*#__PURE__*/Schema.decodeUnknownEffect(Entry.arraySchemaBinary);
  /**
