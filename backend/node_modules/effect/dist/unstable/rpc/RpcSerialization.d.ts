 ...
 * @since 4.0.0
 */
export type CodecFor = <S extends Schema.Top>(schema: S) => Schema.Codec<S["Type"], unknown, S["DecodingServices"], S["EncodingServices"]>;
 ...
 * @since 4.0.0
 */
export declare const layerSchemaBinary: (options?: {
