...
declare const Abandon_base: Context.ServiceClass<Abandon, "effect/cluster/ClusterSchema/Abandon", true>;
/**
 ...
 * @since 4.0.0
 */
export declare class Abandon extends Abandon_base {
    static annotation: Context.Context<Abandon | Cause.StackTrace>;
}
/**
