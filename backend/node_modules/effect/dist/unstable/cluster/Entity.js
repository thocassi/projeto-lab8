...
export const makeTestClient = /*#__PURE__*/Effect.fnUntraced(function* (entity, layer) {
  ...
  const map = yield* ResourceMap.make(Effect.fnUntraced(function* (entityId) {
    ...
    const handlerContext = entityEntry.context.pipe(Context.add(CurrentRunnerAddress, runnerAddress), Context.add(CurrentAddress, address), Context.add(CurrentActivationScope, scope), Context.add(Scope, scope));
