 ...
 * @since 4.0.0
 */
export declare const Reply: <R extends Rpc.Any>(rpc: R, codecFor: RpcSerialization.CodecFor) => Schema.Codec<WithExit<R> | Chunk<R>, Encoded, Rpc.ServicesClient<R>, Rpc.ServicesServer<R>>;
/**
