...
export const config = /*#__PURE__*/Config.all({
  ...
  availableShardGroups: /*#__PURE__*/Config.Array(Schema.String, "availableShardGroups").pipe(/*#__PURE__*/Config.withDefault(["default"])
  // Config.withDescription("The shard groups available across all runners.")
  ),
  assignedShardGroups: /*#__PURE__*/Config.Array(Schema.String, "shardGroups").pipe(/*#__PURE__*/Config.withDefault(["default"])
