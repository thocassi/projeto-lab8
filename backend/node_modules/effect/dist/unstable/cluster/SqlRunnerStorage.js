...
`.pipe(execWithLockConnUnprepared, Effect.andThen(acquiredLocks(address, shardIds)));
  ...
  return RunnerStorage.makeEncoded({
    ...
    refresh: (address, shardIds) => {
      ...
      return withLockOperationDeadline(heartbeat.pipe(execWithLockConn, Effect.andThen(refreshShards(address, shardIds)))).pipe(PersistenceError.refail, withTracerDisabled);
    },
