...
import type { Acquirer, Borrower, Row } from "./SqlConnection.ts";
import type { SqlError } from "./SqlError.ts";
declare const FragmentTypeId = "~effect/sql/Statement/Fragment";
/**
 ...
 * @since 4.0.0
 */
export declare const SpanPropagationEnabled: Context.Reference<boolean>;
/**
 ...
 * @since 4.0.0
 */
export declare const make: (acquirer: Acquirer, compiler: Compiler, spanAttributes: ReadonlyArray<readonly [string, unknown]>, transformRows: (<A extends object>(row: ReadonlyArray<A>) => ReadonlyArray<A>) | undefined, borrower?: Borrower | undefined) => Constructor;
/**
 ...
 * @since 4.0.0
 */
export declare const statement: <A = Row>(acquirer: Acquirer, compiler: Compiler, strings: TemplateStringsArray, args: Array<any>, spanAttributes: ReadonlyArray<readonly [string, unknown]>, transformRows: (<A_1 extends object>(row: ReadonlyArray<A_1>) => ReadonlyArray<A_1>) | undefined, borrower?: Borrower | undefined) => Statement<A>;
/**
