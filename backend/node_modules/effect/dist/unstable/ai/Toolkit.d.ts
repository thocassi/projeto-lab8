...
export interface WithHandler<in out Tools extends Record<string, Tool.Any>> {
     ...
     */
    options?: SchemaAST.ParseOptions) => Effect.Effect<Stream.Stream<Tool.HandlerResult<Tools[Name]>, Tool.HandlerError<Tools[Name]>, Tool.HandlerServices<Tools[Name]>>, AiError.AiError>;
}
/**
 ...
 * @since 4.0.0
 */
export declare const FailureOrigin: Context.Reference<Tool.FailureOrigin>;
/**
