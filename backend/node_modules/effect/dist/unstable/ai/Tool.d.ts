 ...
 * @since 4.0.0
 */
export type FailureResult<T> = T extends Tool<infer _Name, infer _Config, infer _Requirements> ? _Config["failureMode"] extends "return" ? _Config["failure"]["Type"] | typeof ExecutionFailure.Type | AiError.AiError : _Config["failure"]["Type"] | typeof ExecutionFailure.Type : never;
/**
 ...
 * @since 4.0.0
 */
export type FailureResultEncoded<T> = T extends Tool<infer _Name, infer _Config, infer _Requirements> ? _Config["failureMode"] extends "return" ? _Config["failure"]["Encoded"] | typeof ExecutionFailure.Encoded | AiError.AiErrorEncoded : _Config["failure"]["Encoded"] | typeof ExecutionFailure.Encoded : never;
/**
 ...
 * @since 4.0.0
 */
export type ParametersEncodingServices<T> = T extends Tool<infer _Name, infer _Config, infer _Requirements> ? _Config["parameters"]["EncodingServices"] : never;
/**
 ...
 * @since 4.0.0
 */
export declare const ExecutionFailure: Schema.Struct<{
    readonly type: Schema.Literals<readonly ["execution-denied", "execution-interrupted"]>;
 ...
 * @since 4.0.0
 */
export declare const failureResultSchema: <T extends Any>(tool: T) => Schema.Union<readonly [typeof AiError.AiError, T["failureSchema"], typeof ExecutionFailure]>;
/**
