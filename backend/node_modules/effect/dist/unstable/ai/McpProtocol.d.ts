...
export interface StatelessRuntimeDescriptor {
    ...
    readonly transport: TransportPolicy;
    readonly profileFromRequestMetadata: (metadata: unknown) => Effect.Effect<StatelessRuntimeProfile, unknown>;
}
/**
 ...
 * @since 4.0.0
 */
export interface AnyProtocolAdapter<out Version extends string = string, HandlerRequirements = unknown, out Runtime extends RuntimeDescriptor = RuntimeDescriptor> {
 ...
 * @since 4.0.0
 */
export interface ProtocolAdapter<out Version extends ProtocolVersion = ProtocolVersion, out Runtime extends RuntimeDescriptor = RuntimeDescriptor> extends AnyProtocolAdapter<Version, unknown, Runtime> {
}
/**
 ...
 * @since 4.0.0
 */
export declare const v2026_07_28: ProtocolAdapter<"2026-07-28", StatelessRuntimeDescriptor>;
/**
 ...
 * @since 4.0.0
 */
export declare const v2025_11_25: ProtocolAdapter<"2025-11-25", StatefulRuntimeDescriptor>;
/**
 ...
 * @since 4.0.0
 */
export declare const v2025_06_18: ProtocolAdapter<"2025-06-18", StatefulRuntimeDescriptor>;
/**
 ...
 * @since 4.0.0
 */
export declare const v2025_03_26: ProtocolAdapter<"2025-03-26", StatefulRuntimeDescriptor>;
/**
 ...
 * @since 4.0.0
 */
export declare const v2024_11_05: ProtocolAdapter<"2024-11-05", StatefulRuntimeDescriptor>;
