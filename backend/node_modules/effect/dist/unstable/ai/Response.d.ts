...
declare const PartTypeId: "~effect/ai/Response/Part";
/**
 ...
 * @since 4.0.0
 */
export type Part<Tools extends Record<string, Tool.Any>, ParametersMode extends ToolParametersMode = "decoded"> = TextPart | ReasoningPart | ToolCallParts<Tools, ParametersMode> | ToolResultParts<Tools> | ToolApprovalRequestPart | FilePart | DocumentSourcePart | UrlSourcePart | ResponseMetadataPart | FinishPart;
/**
 ...
 * @since 4.0.0
 */
export type StreamPart<Tools extends Record<string, Tool.Any>, ParametersMode extends ToolParametersMode = "decoded"> = TextStartPart | TextDeltaPart | TextEndPart | ReasoningStartPart | ReasoningDeltaPart | ReasoningEndPart | ToolParamsStartPart | ToolParamsDeltaPart | ToolParamsEndPart | ToolCallParts<Tools, ParametersMode> | ToolResultParts<Tools> | ToolApprovalRequestPart | FilePart | DocumentSourcePart | UrlSourcePart | ResponseMetadataPart | FinishPart | ErrorPart;
/**
 ...
 * @since 4.0.0
 */
export type ToolCallParts<Tools extends Record<string, Tool.Any>, ParametersMode extends ToolParametersMode = "decoded"> = ToolCallPartForName<Tools, ParametersMode, keyof Tools>;
/**
...
type ToolCallPartForName<Tools extends Record<string, Tool.Any>, ParametersMode extends ToolParametersMode, Name extends keyof Tools> = Name extends string ? ToolCallPart<Name, ParametersMode extends "encoded" ? Tool.ParametersEncoded<Tools[Name]> : ParametersMode extends "opaque" ? unknown : Tool.Parameters<Tools[Name]>> : never;
/**
...
type ToolResultPartForName<Tools extends Record<string, Tool.Any>, Name extends keyof Tools> = Name extends string ? ToolResultPart<Name, Tool.Success<Tools[Name]>, Tool.FailureResult<Tools[Name]>> : never;
/**
 ...
 * @since 4.0.0
 */
export declare const ToolResultPart: <const Name extends string, Success extends Schema.Constraint, Failure extends Schema.Constraint>(name: Name, success: Success, failure: Failure) => Schema.Codec<ToolResultPart<Name, Success["Type"], Failure["Type"]>, ToolResultPartEncoded, Success["DecodingServices"] | Failure["DecodingServices"], Success["EncodingServices"] | Failure["EncodingServices"]>;
/**
...
export declare const HttpRequestDetails: Schema.Struct<{
    readonly method: Schema.Literals<readonly ["GET", "POST", "PATCH", "PUT", "DELETE", "HEAD", "OPTIONS", "TRACE", "QUERY"]>;
