 ...
 * @since 4.0.0
 */
export declare const LanguageModel: Context.Service<LanguageModel, LanguageModel>;
/**
...
export interface LanguageModel {
    ...
    readonly generateText: {
        ...
        <Tools extends Record<string, Tool.Any>, Options extends NoExcessProperties<GenerateTextOptions<Tools> & {
            ...
            readonly toolkit: ToolkitInput<Tools>;
        }): Effect.Effect<GenerateTextResponse<Tools, ExtractToolParametersMode<Options>>, ExtractError<Options>, ExtractServices<Options>>;
        <Options extends {
    ...
    readonly streamText: {
        ...
        <Tools extends Record<string, Tool.Any>, Options extends NoExcessProperties<GenerateTextOptions<Tools> & {
            ...
            readonly toolkit: ToolkitInput<Tools>;
        }): Stream.Stream<Response.StreamPart<Tools, ExtractToolParametersMode<Options>>, ExtractError<Options>, ExtractServices<Options>>;
        <Options extends {
            readonly toolkit: ToolkitOption<any>;
        } & NoExcessProperties<GenerateTextOptions<any>, Options>>(options: Options & GenerateTextOptions<ExtractTools<Options>> & {
            readonly toolkit: Options["toolkit"];
        }): Stream.Stream<Response.StreamPart<ExtractTools<Options>, ExtractToolParametersMode<Options>>, ExtractError<Options>, ExtractServices<Options>>;
    };
}
/**
 ...
 * @since 4.0.0
 */
export declare class GenerateTextResponse<Tools extends Record<string, Tool.Any>, ParametersMode extends Response.ToolParametersMode = "decoded"> {
 ...
 * @since 4.0.0
 */
export declare class GenerateObjectResponse<Tools extends Record<string, Tool.Any>, A, ParametersMode extends Response.ToolParametersMode = "decoded"> extends GenerateTextResponse<Tools, ParametersMode> {
    /**
...
type ExtractServicesFromToolkitOption<ToolkitValue> = ToolkitValue extends Toolkit.WithHandler<infer Tools> ? Tool.HandlerServices<Tools[keyof Tools]> | Tool.ResultDecodingServices<Tools[keyof Tools]> | Tool.ParametersEncodingServices<Tools[keyof Tools]> : ToolkitValue extends Effect.Effect<Toolkit.WithHandler<infer Tools>, infer _E, infer R> ? Tool.HandlerServices<Tools[keyof Tools]> | Tool.ResultDecodingServices<Tools[keyof Tools]> | Tool.ParametersEncodingServices<Tools[keyof Tools]> | R : never;
type ExtractDisabledResolutionServicesFromToolkitOption<ToolkitValue> = ToolkitValue extends Toolkit.WithHandler<infer Tools> ? Tool.ParametersEncodingServices<Tools[keyof Tools]> : ToolkitValue extends Toolkit.Toolkit<infer Tools> ? Tool.ParametersEncodingServices<Tools[keyof Tools]> : ToolkitValue extends Effect.Effect<Toolkit.WithHandler<infer Tools>, infer _E, infer R> ? Tool.ParametersEncodingServices<Tools[keyof Tools]> | R : never;
/**
...
export type ExtractServices<Options> = Options extends {
    ...
    readonly toolkit: infer ToolkitValue;
} ? ExtractDisabledResolutionServicesFromToolkitOption<Exclude<ToolkitValue, undefined>> : never : Options extends {
    readonly toolkit: infer ToolkitValue;
} ? ExtractServicesFromToolkitOption<Exclude<ToolkitValue, undefined>> : never;
/**
...
export declare const generateText: {
    ...
    <Tools extends Record<string, Tool.Any>, Options extends NoExcessProperties<GenerateTextOptions<Tools> & {
        ...
        readonly toolkit: ToolkitInput<Tools>;
    }): Effect.Effect<GenerateTextResponse<Tools, ExtractToolParametersMode<Options>>, ExtractError<Options>, LanguageModel | ExtractServices<Options>>;
    <Options extends {
        readonly toolkit: ToolkitOption<any>;
    } & NoExcessProperties<GenerateTextOptions<any>, Options>>(options: Options & GenerateTextOptions<ExtractTools<Options>> & {
        readonly toolkit: Options["toolkit"];
    }): Effect.Effect<GenerateTextResponse<ExtractTools<Options>, ExtractToolParametersMode<Options>>, ExtractError<Options>, ExtractServices<Options> | LanguageModel>;
};
/**
 ...
 * @since 4.0.0
 */
export declare const generateObject: <ObjectEncoded extends Record<string, any>, StructuredOutputSchema extends Schema.Encoder<ObjectEncoded, unknown>, Options extends NoExcessProperties<GenerateObjectOptions<any, StructuredOutputSchema>, Options>>(options: Options & GenerateObjectOptions<ExtractTools<Options>, StructuredOutputSchema>) => Effect.Effect<GenerateObjectResponse<ExtractTools<Options>, StructuredOutputSchema["Type"], ExtractToolParametersMode<Options>>, ExtractError<Options>, ExtractServices<Options> | StructuredOutputSchema["DecodingServices"] | LanguageModel>;
/**
...
export declare const streamText: {
    ...
    <Tools extends Record<string, Tool.Any>, Options extends NoExcessProperties<GenerateTextOptions<Tools> & {
        ...
        readonly toolkit: ToolkitInput<Tools>;
    }): Stream.Stream<Response.StreamPart<Tools, ExtractToolParametersMode<Options>>, ExtractError<Options>, ExtractServices<Options> | LanguageModel>;
    <Options extends {
        readonly toolkit: ToolkitOption<any>;
    } & NoExcessProperties<GenerateTextOptions<any>, Options>>(options: Options & GenerateTextOptions<ExtractTools<Options>> & {
        readonly toolkit: Options["toolkit"];
    }): Stream.Stream<Response.StreamPart<ExtractTools<Options>, ExtractToolParametersMode<Options>>, ExtractError<Options>, ExtractServices<Options> | LanguageModel>;
};
export {};
