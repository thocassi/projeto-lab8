...
declare const ParseOptions_base: Context.ServiceClass<ParseOptions, "effect/httpapi/HttpApi/ParseOptions", SchemaAST.ParseOptions>;
/**
 ...
 * @since 4.0.0
 */
export declare class ParseOptions extends ParseOptions_base {
}
export {};
