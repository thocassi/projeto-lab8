 ...
 * @since 4.0.0
 */
export declare const isArbitrary: (u: unknown) => u is Arbitrary<unknown>;
/**
 ...
 * @since 4.0.0
 */
export declare function formatCheckFailure<A, E>(result: CheckResult<A, E>): string | undefined;
/**
 ...
 * @since 4.0.0
 */
export declare function schema<S extends Schema_.Constraint>(schema: S, options?: SchemaOptions<S["Type"]>): Arbitrary<S["Type"]>;
/**
 ...
 * @since 4.0.0
 */
export declare function Constant<const A>(value: A): Arbitrary<A>;
/**
 ...
 * @since 4.0.0
 */
export declare const array: <A>(item: Arbitrary<A>, options?: ArrayOptions) => Arbitrary<Array<A>>;
/**
 ...
 * @since 4.0.0
 */
export declare function all<const Input extends Iterable<Arbitrary<any>> | Record<string, Arbitrary<any>>>(input: Input): Arbitrary<[
    Input
] extends [ReadonlyArray<Arbitrary<any>>] ? {
    -readonly [K in keyof Input]: [Input[K]] extends [Arbitrary<infer A>] ? A : never;
} : [Input] extends [Iterable<Arbitrary<infer A>>] ? Array<A> : [Input] extends [Record<string, Arbitrary<any>>] ? {
    -readonly [K in keyof Input]: [Input[K]] extends [Arbitrary<infer A>] ? A : never;
} : never>;
/**
 ...
 * @since 4.0.0
 */
export declare function sampleEffect<A>(self: Arbitrary<A>, options?: SampleOptions): Effect.Effect<ReadonlyArray<A>, SampleError>;
/**
 ...
 * @since 4.0.0
 */
export declare function checkEffect<A, E = never, R = never>(self: Arbitrary<A>, property: (value: A) => boolean | Effect.Effect<boolean, E, R>, options?: CheckOptions): Effect.Effect<CheckResult<A, E>, never, R>;
