 ...
 * @since 4.0.0
 */
export declare const Int: (name: string) => Flag<number>;
/**
 ...
 * @since 4.0.0
 */
export declare const Finite: (name: string) => Flag<number>;
/**
 ...
 * @since 4.0.0
 */
export declare const Date: (name: string) => Flag<globalThis.Date>;
/**
 ...
 * @since 4.0.0
 */
export declare const Literals: <const Literals extends ReadonlyArray<string>>(name: string, literals: Literals) => Flag<Literals[number]>;
/**
 ...
 * @since 4.0.0
 */
export declare const Redacted: (name: string) => Flag<Redacted_.Redacted<string>>;
/**
 ...
 * @since 4.0.0
 */
export declare const Never: Flag<never>;
/**
