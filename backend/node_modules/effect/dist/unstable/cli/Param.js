 ...
 * @since 4.0.0
 */
export const Int = (kind, name) => makeSingle({
  name,
 ...
 * @since 4.0.0
 */
export const Finite = (kind, name) => makeSingle({
  name,
 ...
 * @since 4.0.0
 */
export const Literals = (kind, name, choices) => {
 ...
 * @since 4.0.0
 */
export const Never = kind => makeSingle({
  name: "__never__",
...
const parsePositionalVariadic = /*#__PURE__*/Effect.fnUntraced(function* (self, single, args, options) {
  ...
  if (count < minValue) {
    return yield* count === 0 ? new CliError.MissingArgument({
