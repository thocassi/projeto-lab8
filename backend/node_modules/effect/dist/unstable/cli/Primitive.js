...
/** @internal */
export const isTrueLiteral = /*#__PURE__*/Schema.is(Schema.TrueLiterals);
/** @internal */
export const isFalseLiteral = /*#__PURE__*/Schema.is(Schema.FalseLiterals);
/** @internal */
 ...
 * @since 4.0.0
 */
export const Boolean = /*#__PURE__*/makeSchemaPrimitive("Boolean", Schema.BooleanLiterals);
/**
 ...
 * @since 4.0.0
 */
export const Finite = /*#__PURE__*/makeSchemaPrimitive("Finite", Schema.Finite);
/**
 ...
 * @since 4.0.0
 */
export const Int = /*#__PURE__*/makeSchemaPrimitive("Int", Schema.Int);
/**
 ...
 * @since 4.0.0
 */
export const Redacted = /*#__PURE__*/makePrimitive("Redacted", value => Effect.succeed(Redacted_.make(value)));
/**
 ...
 * @since 4.0.0
 */
export const Never = /*#__PURE__*/makePrimitive("Never", () => Effect.fail("This option does not accept values"));
/**
