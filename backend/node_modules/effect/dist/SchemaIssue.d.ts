 ...
 * @since 4.0.0
 */
export declare const Filter: new (
/**
 * The filter that failed.
 */
 ...
 */
options?: SchemaAST.ParseOptions) => Filter;
/**
 ...
 * @since 4.0.0
 */
export declare const Encoding: new (ast: SchemaAST.AST, issue: Issue, input?: unknown, options?: SchemaAST.ParseOptions) => Encoding;
/**
 ...
 * @since 4.0.0
 */
export declare const Pointer: new (path: ReadonlyArray<PropertyKey>, issue: Issue) => Pointer;
/**
 ...
 * @since 4.0.0
 */
export declare const MissingKey: new (annotations: Schema.Annotations.Key<unknown> | undefined) => MissingKey;
/**
 ...
 * @since 4.0.0
 */
export declare const UnexpectedKey: new (ast: SchemaAST.AST, input?: unknown, options?: SchemaAST.ParseOptions) => UnexpectedKey;
/**
 ...
 * @since 4.0.0
 */
export declare const Composite: new (ast: SchemaAST.AST, issues: readonly [Issue, ...Array<Issue>], input?: unknown, options?: SchemaAST.ParseOptions) => Composite;
/**
 ...
 * @since 4.0.0
 */
export declare const InvalidType: new (ast: SchemaAST.AST, input?: unknown, options?: SchemaAST.ParseOptions) => InvalidType;
/**
 ...
 * @since 4.0.0
 */
export declare const InvalidValue: new (annotations?: Schema.Annotations.Issue | undefined, input?: unknown, options?: SchemaAST.ParseOptions) => InvalidValue;
/**
 ...
 * @since 4.0.0
 */
export declare const Forbidden: new (annotations: Schema.Annotations.Issue | undefined, input?: unknown, options?: SchemaAST.ParseOptions) => Forbidden;
/**
 ...
 * @since 4.0.0
 */
export declare const AnyOf: new (ast: SchemaAST.Union, issues: ReadonlyArray<Issue>, input?: unknown, options?: SchemaAST.ParseOptions) => AnyOf;
/**
 ...
 * @since 4.0.0
 */
export declare const OneOf: new (ast: SchemaAST.Union, successes: ReadonlyArray<SchemaAST.AST>, input?: unknown, options?: SchemaAST.ParseOptions) => OneOf;
/**
