 ...
 * @since 4.0.0
 */
export const Middleware = class extends Pipeable.Class {
  _tag = "Middleware";
  decode;
  encode;
 ...
 * @since 4.0.0
 */
export const Transformation = class extends Pipeable.Class {
  [TypeId] = TypeId;
  _tag = "Transformation";
  decode;
  encode;
 ...
 * @since 4.0.0
 */
export const composeTransformation = /*#__PURE__*/dual(2, (self, other) => new Transformation(SchemaGetter.compose(self.decode, other.decode), SchemaGetter.compose(other.encode, self.encode)));
/**
 ...
 * @since 3.10.0
 */
export const makeTransformation = options => {
...
export const byteSizeFromString = /*#__PURE__*/transformEffect({
  decode: (input, options) => Option.match(ByteSize.fromString(input), {
    onNone: () => Effect.fail(new SchemaIssue.InvalidValue({
