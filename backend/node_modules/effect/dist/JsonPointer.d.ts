 ...
 * @since 4.0.0
 */
export declare function parseUriFragment(fragment: string): ReadonlyArray<string> | undefined;
/**
 ...
 * @since 4.0.0
 */
export declare function formatUriFragment(path: ReadonlyArray<string>): string;
