...
declare const TypeId = "~effect/FileSystem";
/**
...
export interface FileSystem {
     ...
     */
    readonly truncate: (path: string, length?: number) => Effect.Effect<void, PlatformError>;
    /**
 ...
 * @since 4.0.0
 */
export declare const FileTypeId = "~effect/FileSystem/File";
/**
...
declare const WatchBackend_base: Context.ServiceClass<WatchBackend, "effect/FileSystem/WatchBackend", {
