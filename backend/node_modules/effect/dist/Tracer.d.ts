 ...
 * @since 4.0.0
 */
export declare const nativeTracer: Tracer;
/**
...
export declare class NativeSpan implements Span {
    ...
    _spanId: string | undefined;
    _attributes: Map<string, unknown> | undefined;
    _events: Array<[name: string, startTime: bigint, attributes: Record<string, unknown>]> | undefined;
    constructor(options: {
        readonly name: string;
        readonly parent: Option.Option<AnySpan>;
        readonly annotations: Context.Context<never>;
