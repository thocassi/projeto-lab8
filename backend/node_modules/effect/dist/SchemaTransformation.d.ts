 ...
 * @since 4.0.0
 */
export declare const Middleware: new <T, E, RDE, RDT, RET, REE>(decode: (effect: Effect.Effect<Option.Option<E>, SchemaIssue.Issue, RDE>, options: SchemaAST.ParseOptions) => Effect.Effect<Option.Option<T>, SchemaIssue.Issue, RDT>, encode: (effect: Effect.Effect<Option.Option<T>, SchemaIssue.Issue, RET>, options: SchemaAST.ParseOptions) => Effect.Effect<Option.Option<E>, SchemaIssue.Issue, REE>) => Middleware<T, E, RDE, RDT, RET, REE>;
 ...
 * @since 4.0.0
 */
export declare const Transformation: new <T, E, RD = never, RE = never>(decode: SchemaGetter.Getter<T, E, RD>, encode: SchemaGetter.Getter<E, T, RE>) => Transformation<T, E, RD, RE>;
/**
 ...
 * @since 4.0.0
 */
export declare const composeTransformation: {
    /**
     * Composes two schema transformations into a single bidirectional conversion.
     *
     * **When to use**
     ...
     * @since 4.0.0
     */
    <T, T2, RD2, RE2>(other: Transformation<T2, T, RD2, RE2>): <E, RD, RE>(self: Transformation<T, E, RD, RE>) => Transformation<T2, E, RD | RD2, RE | RE2>;
    /**
     * Composes two schema transformations into a single bidirectional conversion.
     *
     * **When to use**
     ...
     * @since 4.0.0
     */
    <T, E, RD, RE, T2, RD2, RE2>(self: Transformation<T, E, RD, RE>, other: Transformation<T2, T, RD2, RE2>): Transformation<T2, E, RD | RD2, RE | RE2>;
};
/**
 ...
 * @since 3.10.0
 */
export declare const makeTransformation: <T, E, RD = never, RE = never>(options: {
    readonly decode: SchemaGetter.Getter<T, E, RD>;
    readonly encode: SchemaGetter.Getter<E, T, RE>;
 ...
 * @since 3.10.0
 */
export declare function transformEffect<T, E, RD = never, RE = never>(options: {
 ...
 * @since 4.0.0
 */
export declare const byteSizeFromString: Transformation<ByteSize.ByteSize, string>;
/**
 ...
 * @since 4.0.0
 */
export declare const byteSizeFromBigInt: Transformation<ByteSize.ByteSize, bigint>;
/**
 ...
 * @since 4.0.0
 */
export declare const byteSizeFromNumber: Transformation<ByteSize.ByteSize, number>;
/**
