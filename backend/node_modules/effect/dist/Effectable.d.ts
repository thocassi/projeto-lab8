...
declare abstract class MixinBase extends Class<any, any, any> {
    ...
    readonly [Effect.TypeId]: AsEffectReturn<this>[Effect.TypeId];
 ...
 * @since 4.0.0
 */
export declare const Mixin: <TBase extends abstract new (...args: ReadonlyArray<any>) => object>(klass: TBase) => TBase & typeof MixinBase;
export {};
