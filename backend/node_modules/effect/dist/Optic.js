...
class OptionalImpl {
  ...
  optionalKey(key) {
    return make(compose(this.node, primitiveNode("Lens", s => s[key], (a, s) => {
      ...
      if (a === undefined) {
        if (Array.isArray(copy) && (typeof key === "number" || typeof key === "string" && Arr.isCanonicalArrayIndex(key))) {
