 ...
 * @since 2.0.0
 */
export const mapBoth = /*#__PURE__*/dual(2, (self, options) => self.pipe(map(options.onElement), mapError(options.onError)));
/**
 ...
 * @since 4.0.0
 */
export const tapDefect = /*#__PURE__*/dual(2, (self, f) => tapCause(self, cause => {
 ...
 * @since 2.0.0
 */
export const scanEffect = /*#__PURE__*/dual(3, (self, initial, f) => suspend(() => self.channel.pipe(Channel.flattenArray, Channel.scanEffect(initial(), f), Channel.map(Arr.of), fromChannel)));
/**
 ...
 * @since 2.0.0
 */
export const bind = /*#__PURE__*/dual(args => isStream(args[0]), (self, name, f, options) => flatMap(self, a => map(f(a), b => ({
  ...a,
  [name]: b
})), options));
/**
 ...
 * @since 2.0.0
 */
export const bindEffect = /*#__PURE__*/dual(args => isStream(args[0]), (self, name, f, options) => mapEffect(self, a => Effect.map(f(a), b => ({
  ...a,
  [name]: b
})), options));
/**
