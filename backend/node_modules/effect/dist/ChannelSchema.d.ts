 ...
 * @since 4.0.0
 */
export declare const decode: <S extends Schema.Constraint>(schema: S, options?: SchemaAST.ParseOptions) => <IE = never, Done = unknown>() => Channel.Channel<Arr.NonEmptyReadonlyArray<S["Type"]>, IE | Schema.SchemaError, Done, Arr.NonEmptyReadonlyArray<S["Encoded"]>, IE, Done, S["DecodingServices"]>;
/**
 ...
 * @since 4.0.0
 */
export declare const decodeUnknown: <S extends Schema.Constraint>(schema: S, options?: SchemaAST.ParseOptions) => <IE = never, Done = unknown>() => Channel.Channel<Arr.NonEmptyReadonlyArray<S["Type"]>, IE | Schema.SchemaError, Done, Arr.NonEmptyReadonlyArray<unknown>, IE, Done, S["DecodingServices"]>;
/**
