...
export interface TransformEffect<out T, in E, R> extends Pipeable.Pipeable {
    ...
    readonly transform: (input: E, options: SchemaAST.ParseOptions) => Effect.Effect<T, SchemaIssue.Issue, R>;
}
/**
...
export interface TransformOptionalEffect<out T, in E, R> extends Pipeable.Pipeable {
    ...
    readonly transform: (input: Option.Option<E>, options: SchemaAST.ParseOptions) => Effect.Effect<Option.Option<T>, SchemaIssue.Issue, R>;
}
/**
 ...
 * @since 4.0.0
 */
export type Getter<T, E, R = never> = Passthrough | Transform<T, E> | TransformOptional<T, E> | TransformEffect<T, E, R> | TransformOptionalEffect<T, E, R>;
/**
...
export declare const run: {
     ...
     * @since 4.0.0
     */
    <E>(input: Option.Option<E>, options: SchemaAST.ParseOptions): <T, R>(self: Getter<T, E, R>) => Effect.Effect<Option.Option<T>, SchemaIssue.Issue, R>;
    /**
     * Runs a getter directly.
     *
     * **Details**
     ...
     * @since 4.0.0
     */
    <T, E, R>(self: Getter<T, E, R>, input: Option.Option<E>, options: SchemaAST.ParseOptions): Effect.Effect<Option.Option<T>, SchemaIssue.Issue, R>;
};
/**
 ...
 * @since 4.0.0
 */
export declare const forbiddenEncoding: Getter<never, unknown>;
/**
 ...
 * @since 4.0.0
 */
export declare function transformEffect<T, E, R = never>(f: (e: E, options: SchemaAST.ParseOptions) => Effect.Effect<T, SchemaIssue.Issue, R>): Getter<T, E, R>;
/**
 ...
 * @since 4.0.0
 */
export declare function transformOptionalEffect<T, E, R = never>(f: (input: Option.Option<E>, options: SchemaAST.ParseOptions) => Effect.Effect<Option.Option<T>, SchemaIssue.Issue, R>): Getter<T, E, R>;
/**
